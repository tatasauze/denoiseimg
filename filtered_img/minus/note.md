...
觀察結果：高斯與平均filter肉眼可見的將邊界變得模糊，median 較這兩個方式更保有sharp（銳利嗎，反正就是邊界色彩度差異更大）邊界，但bilateral filter 才是這幾個中保真度最高的，邊界最清晰，空間與色彩範圍從1~5共產生25張降噪圖像，我看不太出來這兩個參數在這區間造成的具體視覺變化，但肉眼可分辨的是當空間與色彩變異數都是1的時候，最能保有lena帽子上的紋理
